...
import com.ksd.sql.MaterialOutStorageSql;
...
public class MaterialOutStorageJson {
    public static void test() throws Exception {
        List<MaterialOutStorageEntity> list= MaterialOutStorageSql.materialQuery();
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            List<MaterialOutStorageFEntity>  materialOutStorageFEntity=	MaterialOutStorageSql.entityQuery();
            JSONArray FEntity = new JSONArray();
            for (int j = 0; j < materialOutStorageFEntity.size(); j++) {
