...
public class OtherOutStorageEntity {
    private Integer FID;
    ...
    private List<OtherOutStorageFEntity> OtherOutStorageFEntity;

    public List<com.ksd.entity.OtherOutStorageFEntity> getOtherOutStorageFEntity() {
        return OtherOutStorageFEntity;
    }

    public void setOtherOutStorageFEntity(List<com.ksd.entity.OtherOutStorageFEntity> otherOutStorageFEntity) {
        OtherOutStorageFEntity = otherOutStorageFEntity;
    }
